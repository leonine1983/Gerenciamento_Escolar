...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0145_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cidade_nascimento', to='gestao_escolar.cidade'),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('4', 'Divorciado'), ('3', 'Separado'), ('2', 'Casado'), ('1', 'Solteiro'), ('5', 'Viúvo'), ('6', 'União Estável')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('2', 'A-'), ('6', 'AB-'), ('8', 'O-'), ('0', 'Não informado'), ('4', 'B-'), ('1', 'A+'), ('7', 'O+'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
