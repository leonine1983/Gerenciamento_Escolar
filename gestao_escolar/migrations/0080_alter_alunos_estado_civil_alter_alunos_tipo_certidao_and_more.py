...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0079_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('0', 'Não informado'), ('7', 'O+'), ('4', 'B-'), ('8', 'O-'), ('1', 'A+'), ('3', 'B+'), ('2', 'A-'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
