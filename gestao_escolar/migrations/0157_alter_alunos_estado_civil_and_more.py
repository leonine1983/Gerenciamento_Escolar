# Generated by Django 5.0.4 on 2024-07-29 17:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0156_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('7', 'O+'), ('4', 'B-'), ('3', 'B+'), ('6', 'AB-'), ('8', 'O-'), ('0', 'Não informado'), ('1', 'A+'), ('5', 'AB+'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
