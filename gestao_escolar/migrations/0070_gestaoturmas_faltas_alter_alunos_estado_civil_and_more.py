# Generated by Django 5.0.4 on 2024-05-28 13:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0069_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('5', 'AB+'), ('4', 'B-'), ('0', 'Não informado'), ('3', 'B+'), ('7', 'O+'), ('8', 'O-'), ('6', 'AB-'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
