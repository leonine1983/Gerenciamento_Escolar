...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0014_alter_alunos_tipo_sanguineo_and_more'),
    ]

    operations = [
        migrations.AddField(
            model_name='turmas',
            name='descritivo_turma',
            field=models.CharField(default='única', max_length=10),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('6', 'AB-'), ('2', 'A-'), ('8', 'O-'), ('4', 'B-'), ('3', 'B+'), ('0', 'Não informado'), ('5', 'AB+'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
