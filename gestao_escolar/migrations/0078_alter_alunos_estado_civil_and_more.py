# Generated by Django 5.0.4 on 2024-05-28 15:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0077_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('6', 'União Estável'), ('5', 'Viúvo'), ('4', 'Divorciado'), ('2', 'Casado'), ('1', 'Solteiro'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('7', 'O+'), ('4', 'B-'), ('6', 'AB-'), ('8', 'O-'), ('1', 'A+'), ('0', 'Não informado'), ('5', 'AB+'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
