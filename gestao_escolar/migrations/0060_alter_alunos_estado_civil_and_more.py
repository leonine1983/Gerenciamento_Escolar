...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0059_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('3', 'Separado'), ('5', 'Viúvo'), ('6', 'União Estável'), ('4', 'Divorciado'), ('2', 'Casado'), ('1', 'Solteiro')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('8', 'O-'), ('5', 'AB+'), ('6', 'AB-'), ('7', 'O+'), ('4', 'B-'), ('0', 'Não informado'), ('1', 'A+'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
        ...
        migrations.AlterField(
            ...
            name='aluno',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='gestao_turmas_related', to='gestao_escolar.matriculas'),
        ),
        migrations.AlterField(
