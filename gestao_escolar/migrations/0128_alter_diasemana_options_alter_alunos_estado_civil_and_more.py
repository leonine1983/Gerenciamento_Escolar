...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0127_alter_alunos_estado_civil_and_more'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='diasemana',
            options={'ordering': ['numero_dia']},
        ),
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('1', 'Solteiro'), ('4', 'Divorciado'), ('3', 'Separado'), ('2', 'Casado'), ('5', 'Viúvo'), ('6', 'União Estável')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('6', 'AB-'), ('7', 'O+'), ('1', 'A+'), ('8', 'O-'), ('0', 'Não informado'), ('2', 'A-'), ('5', 'AB+'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
