# Generated by Django 5.0.4 on 2024-06-07 12:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0119_validade_horario_nome_validade_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('7', 'O+'), ('8', 'O-'), ('2', 'A-'), ('3', 'B+'), ('4', 'B-'), ('1', 'A+'), ('6', 'AB-'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
