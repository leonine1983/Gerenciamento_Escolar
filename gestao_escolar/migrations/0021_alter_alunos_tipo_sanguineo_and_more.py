...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0020_remove_alunos_documentacao_situacao_familiar_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('4', 'B-'), ('7', 'O+'), ('5', 'AB+'), ('1', 'A+'), ('3', 'B+'), ('8', 'O-'), ('6', 'AB-'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='alunos_documentacao',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('6', 'União Estável'), ('3', 'Separado'), ('5', 'Viúvo'), ('2', 'Casado'), ('4', 'Divorciado'), ('1', 'Solteiro')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos_documentacao',
