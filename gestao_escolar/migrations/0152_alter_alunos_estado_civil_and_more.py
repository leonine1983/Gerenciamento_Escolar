# Generated by Django 5.0.4 on 2024-07-24 16:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0151_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('3', 'Separado'), ('4', 'Divorciado'), ('6', 'União Estável'), ('2', 'Casado'), ('5', 'Viúvo'), ('1', 'Solteiro')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('2', 'A-'), ('1', 'A+'), ('7', 'O+'), ('8', 'O-'), ('5', 'AB+'), ('4', 'B-'), ('3', 'B+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
