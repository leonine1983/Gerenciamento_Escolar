...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0096_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('4', 'B-'), ('1', 'A+'), ('3', 'B+'), ('7', 'O+'), ('8', 'O-'), ('5', 'AB+'), ('2', 'A-'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='horario',
            name='turno',
            field=models.CharField(choices=[('Matutino', 'Matutino'), ('Noturno', 'Noturno'), ('Verspertino', 'Verspertino')], max_length=30, null=True),
        ),
        migrations.AlterField(
