# Generated by Django 5.0.4 on 2024-07-29 17:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0159_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('3', 'Separado'), ('2', 'Casado'), ('4', 'Divorciado'), ('5', 'Viúvo'), ('6', 'União Estável'), ('1', 'Solteiro')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_certidao',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('5', 'AB+'), ('8', 'O-'), ('6', 'AB-'), ('2', 'A-'), ('7', 'O+'), ('4', 'B-'), ('1', 'A+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
