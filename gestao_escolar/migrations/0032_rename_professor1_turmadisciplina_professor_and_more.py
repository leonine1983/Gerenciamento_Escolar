# Generated by Django 5.0.4 on 2024-05-16 12:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0031_remove_turmadisciplina_professor_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('1', 'A+'), ('5', 'AB+'), ('4', 'B-'), ('7', 'O+'), ('0', 'Não informado'), ('8', 'O-'), ('2', 'A-'), ('6', 'AB-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
