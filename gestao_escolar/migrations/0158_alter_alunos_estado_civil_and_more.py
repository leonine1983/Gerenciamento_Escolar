# Generated by Django 5.0.4 on 2024-07-29 17:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0157_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('2', 'Casado'), ('4', 'Divorciado'), ('1', 'Solteiro'), ('6', 'União Estável'), ('5', 'Viúvo'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('5', 'AB+'), ('4', 'B-'), ('2', 'A-'), ('1', 'A+'), ('0', 'Não informado'), ('8', 'O-'), ('3', 'B+'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
