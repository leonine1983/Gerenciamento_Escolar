...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0081_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('1', 'Solteiro'), ('6', 'União Estável'), ('4', 'Divorciado'), ('3', 'Separado'), ('2', 'Casado'), ('5', 'Viúvo')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_certidao',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('7', 'O+'), ('4', 'B-'), ('1', 'A+'), ('5', 'AB+'), ('8', 'O-'), ('2', 'A-'), ('6', 'AB-'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
