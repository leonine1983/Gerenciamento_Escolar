...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0125_alter_horario_options_remove_horario_quarta_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('6', 'AB-'), ('5', 'AB+'), ('0', 'Não informado'), ('2', 'A-'), ('8', 'O-'), ('3', 'B+'), ('1', 'A+'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
