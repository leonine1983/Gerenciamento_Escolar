# Generated by Django 5.0.4 on 2024-05-05 01:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0016_alunos_res_atualiza_cadastro_alunos_res_cadastro_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('2', 'A-'), ('5', 'AB+'), ('8', 'O-'), ('4', 'B-'), ('3', 'B+'), ('1', 'A+'), ('7', 'O+'), ('6', 'AB-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='alunos_documentacao',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('4', 'Divorciado'), ('5', 'Viúvo'), ('6', 'União Estável'), ('2', 'Casado'), ('1', 'Solteiro'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos_documentacao',
