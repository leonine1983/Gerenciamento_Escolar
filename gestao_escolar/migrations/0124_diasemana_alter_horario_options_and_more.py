# Generated by Django 5.0.4 on 2024-06-08 21:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0123_validade_horario_horario_ativo_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('1', 'A+'), ('2', 'A-'), ('8', 'O-'), ('4', 'B-'), ('5', 'AB+'), ('3', 'B+'), ('7', 'O+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
