...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0005_alter_alunos_tipo_sanguineo_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('7', 'O+'), ('5', 'AB+'), ('8', 'O-'), ('2', 'A-'), ('3', 'B+'), ('6', 'AB-'), ('0', 'Não informado'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
