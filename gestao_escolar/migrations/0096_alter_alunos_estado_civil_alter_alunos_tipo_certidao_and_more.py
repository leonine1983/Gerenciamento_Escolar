# Generated by Django 5.0.4 on 2024-06-01 23:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0095_turmadisciplina_quant_aulas_dia_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('0', 'Não informado'), ('8', 'O-'), ('3', 'B+'), ('6', 'AB-'), ('7', 'O+'), ('2', 'A-'), ('5', 'AB+'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
