# Generated by Django 5.0.4 on 2024-06-10 23:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0128_alter_diasemana_options_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('5', 'AB+'), ('1', 'A+'), ('4', 'B-'), ('2', 'A-'), ('3', 'B+'), ('7', 'O+'), ('6', 'AB-'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
