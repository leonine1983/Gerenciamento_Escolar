    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_sanguineo', models.CharField(choices=[('3', 'B+'), ('0', 'Não informado'), ('7', 'O+'), ('2', 'A-'), ('8', 'O-'), ('4', 'B-'), ('6', 'AB-'), ('5', 'AB+'), ('1', 'A+')], max_length=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('Transferido', 'Noturno'), ('Desistente', 'Desistente/Evasão Escolar'), ('Ativo', 'Na Turma')], default='Ativo', max_length=26, verbose_name='Tipo de remanejamento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_civil', models.CharField(blank=True, choices=[('1', 'Solteiro'), ('4', 'Divorciado'), ('5', 'Viúvo'), ('2', 'Casado'), ('6', 'União Estável'), ('3', 'Separado')], max_length=13, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escolarizacao_fora', models.CharField(choices=[('1', 'Não recebe'), ('3', 'Em domicílio'), ('2', 'Em hospital')], default=1, max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('turno', models.CharField(choices=[('Noturno', 'Noturno'), ('Matutino', 'Matutino'), ('Verspertino', 'Verspertino')], default=1, max_length=12)),
