# Generated by Django 5.0.4 on 2024-07-24 14:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0146_alunos_cidade_nascimento_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cidade_nascimento', to='gestao_escolar.cidade', verbose_name='Cidade onde nasceu'),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('4', 'Divorciado'), ('3', 'Separado'), ('1', 'Solteiro'), ('5', 'Viúvo'), ('6', 'União Estável'), ('2', 'Casado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('2', 'A-'), ('5', 'AB+'), ('7', 'O+'), ('0', 'Não informado'), ('8', 'O-'), ('4', 'B-'), ('6', 'AB-'), ('1', 'A+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
