...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0102_remove_horario_turno_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('3', 'B+'), ('1', 'A+'), ('2', 'A-'), ('4', 'B-'), ('8', 'O-'), ('7', 'O+'), ('0', 'Não informado'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
