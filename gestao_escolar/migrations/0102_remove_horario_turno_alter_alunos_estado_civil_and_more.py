# Generated by Django 5.0.4 on 2024-06-04 11:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0101_remove_horario_disciplina_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('1', 'Solteiro'), ('5', 'Viúvo'), ('6', 'União Estável'), ('2', 'Casado'), ('3', 'Separado'), ('4', 'Divorciado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('8', 'O-'), ('5', 'AB+'), ('2', 'A-'), ('6', 'AB-'), ('0', 'Não informado'), ('1', 'A+'), ('7', 'O+'), ('4', 'B-')], max_length=3, null=True),
        ),
        migrations.AlterField(
