...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0155_alter_alunos_bairro_remove_cidade_nome_estado_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('3', 'B+'), ('6', 'AB-'), ('1', 'A+'), ('8', 'O-'), ('4', 'B-'), ('5', 'AB+'), ('7', 'O+'), ('2', 'A-'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
