# Generated by Django 5.0.4 on 2024-06-02 22:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0100_horario_disciplina_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('3', 'Separado'), ('1', 'Solteiro'), ('4', 'Divorciado'), ('2', 'Casado'), ('6', 'União Estável'), ('5', 'Viúvo')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('5', 'AB+'), ('7', 'O+'), ('8', 'O-'), ('6', 'AB-'), ('2', 'A-'), ('3', 'B+'), ('1', 'A+'), ('4', 'B-'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
