# Generated by Django 5.0.4 on 2024-06-11 22:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0130_alter_horario_options_remove_horario_data_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('2', 'Casado'), ('3', 'Separado'), ('5', 'Viúvo'), ('1', 'Solteiro'), ('4', 'Divorciado'), ('6', 'União Estável')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('8', 'O-'), ('6', 'AB-'), ('4', 'B-'), ('3', 'B+'), ('0', 'Não informado'), ('1', 'A+'), ('5', 'AB+'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
