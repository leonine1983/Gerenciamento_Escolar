...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0057_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='gestaoturmas',
            name='aluno',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gestao_escolar.matriculas'),
        ),
        migrations.AddField(
            model_name='gestaoturmas',
            name='id',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('4', 'B-'), ('2', 'A-'), ('3', 'B+'), ('1', 'A+'), ('6', 'AB-'), ('8', 'O-'), ('0', 'Não informado'), ('5', 'AB+'), ('7', 'O+')], max_length=3, null=True),
        ),
        migrations.AlterField(
