# Generated by Django 5.0.4 on 2024-07-24 13:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0144_alter_alunos_estado_civil_alter_alunos_tipo_certidao_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('1', 'Solteiro'), ('6', 'União Estável'), ('3', 'Separado'), ('4', 'Divorciado'), ('2', 'Casado'), ('5', 'Viúvo')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('8', 'O-'), ('7', 'O+'), ('6', 'AB-'), ('0', 'Não informado'), ('2', 'A-'), ('5', 'AB+'), ('3', 'B+'), ('4', 'B-')], max_length=3, null=True),
        ),
        migrations.AlterField(
