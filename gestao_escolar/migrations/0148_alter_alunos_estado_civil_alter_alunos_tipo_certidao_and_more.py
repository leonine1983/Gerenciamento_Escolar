# Generated by Django 5.0.4 on 2024-07-24 14:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0147_alter_alunos_cidade_nascimento_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('0', 'Não informado'), ('5', 'AB+'), ('6', 'AB-'), ('7', 'O+'), ('4', 'B-'), ('3', 'B+'), ('8', 'O-'), ('2', 'A-')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
