# Generated by Django 5.0.4 on 2024-07-29 17:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0158_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('4', 'B-'), ('2', 'A-'), ('3', 'B+'), ('1', 'A+'), ('8', 'O-'), ('7', 'O+'), ('6', 'AB-'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
