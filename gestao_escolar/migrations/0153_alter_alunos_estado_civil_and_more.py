# Generated by Django 5.0.4 on 2024-07-25 11:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0152_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('2', 'Casado'), ('1', 'Solteiro'), ('3', 'Separado'), ('4', 'Divorciado'), ('5', 'Viúvo'), ('6', 'União Estável')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tel_celular_aluno',
            field=models.CharField(max_length=30, verbose_name='Nº de telefone do aluno*'),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tel_celular_mae',
            field=models.CharField(max_length=30, null=True, verbose_name='Nº do celular do mãe*'),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tel_celular_pai',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('8', 'O-'), ('6', 'AB-'), ('3', 'B+'), ('5', 'AB+'), ('4', 'B-'), ('2', 'A-'), ('7', 'O+'), ('1', 'A+'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
