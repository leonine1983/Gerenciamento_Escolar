# Generated by Django 5.0.4 on 2024-06-01 01:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0092_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='horario',
            name='turno',
            field=models.CharField(choices=[('Verspertino', 'Verspertino'), ('Matutino', 'Matutino'), ('Noturno', 'Noturno')], max_length=30, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('2', 'Casado'), ('1', 'Solteiro'), ('3', 'Separado'), ('5', 'Viúvo'), ('4', 'Divorciado'), ('6', 'União Estável')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_certidao',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('5', 'AB+'), ('8', 'O-'), ('4', 'B-'), ('3', 'B+'), ('7', 'O+'), ('1', 'A+'), ('6', 'AB-'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
        ...
        migrations.AlterField(
            model_name='horario',
            name='periodo',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gestao_escolar.periodo'),
        ),
    ]
