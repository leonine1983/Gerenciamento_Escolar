# Generated by Django 5.0.4 on 2024-05-28 13:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0070_gestaoturmas_faltas_alter_alunos_estado_civil_and_more'),
    ]

    operations = [
        migrations.AddField(
            model_name='gestaoturmas',
            name='profissional_resp',
            field=models.CharField(max_length=40, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('6', 'União Estável'), ('4', 'Divorciado'), ('3', 'Separado'), ('1', 'Solteiro'), ('5', 'Viúvo'), ('2', 'Casado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('2', 'A-'), ('1', 'A+'), ('7', 'O+'), ('0', 'Não informado'), ('6', 'AB-'), ('4', 'B-'), ('3', 'B+'), ('5', 'AB+'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
