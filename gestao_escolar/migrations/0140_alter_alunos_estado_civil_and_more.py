# Generated by Django 5.0.4 on 2024-07-23 12:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0139_alunos_aluno_exterior_alter_alunos_rg_uf_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('6', 'AB-'), ('3', 'B+'), ('0', 'Não informado'), ('2', 'A-'), ('8', 'O-'), ('7', 'O+'), ('1', 'A+'), ('4', 'B-'), ('5', 'AB+')], max_length=3, null=True),
        ),
        migrations.AlterField(
