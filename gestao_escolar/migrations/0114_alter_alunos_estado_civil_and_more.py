# Generated by Django 5.0.4 on 2024-06-06 16:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0113_alter_horario_options_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='estado_civil',
            field=models.CharField(blank=True, choices=[('1', 'Solteiro'), ('2', 'Casado'), ('5', 'Viúvo'), ('4', 'Divorciado'), ('6', 'União Estável'), ('3', 'Separado')], max_length=13, null=True),
        ),
        migrations.AlterField(
            model_name='alunos',
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('1', 'A+'), ('2', 'A-'), ('6', 'AB-'), ('8', 'O-'), ('5', 'AB+'), ('0', 'Não informado'), ('7', 'O+'), ('4', 'B-'), ('3', 'B+')], max_length=3, null=True),
        ),
        migrations.AlterField(
