...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0009_alter_alunos_tipo_sanguineo_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('0', 'Não informado'), ('7', 'O+'), ('4', 'B-'), ('6', 'AB-'), ('2', 'A-'), ('3', 'B+'), ('5', 'AB+'), ('1', 'A+'), ('8', 'O-')], max_length=3, null=True),
        ),
        migrations.AlterField(
