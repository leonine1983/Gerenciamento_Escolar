# Generated by Django 5.0.4 on 2024-07-29 15:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestao_escolar', '0153_alter_alunos_estado_civil_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='alunos',
            name='tipo_sanguineo',
            field=models.CharField(choices=[('7', 'O+'), ('1', 'A+'), ('2', 'A-'), ('5', 'AB+'), ('6', 'AB-'), ('3', 'B+'), ('8', 'O-'), ('4', 'B-'), ('0', 'Não informado')], max_length=3, null=True),
        ),
        migrations.AlterField(
            model_name='cursos',
            name='nivel',
