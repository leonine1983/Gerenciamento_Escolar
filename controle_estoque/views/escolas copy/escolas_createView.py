...
class Escolas_CreateView(CreateView):
    model = Escolas_model
    fields = '__all__'
    template_name = 'Controle_Estoque/escolas/escola_cadastro.html'
    success_url =  reverse_lazy('Controle_Estoque:escolas_lista')
    ...
    def get_context_data(self, **kwargs):
        ...
        context["title"] = 'Cadastro de instituições escolares ou outros departamentos'
